...
const erisPath = path.join(import.meta.url, "../types/eris.d.ts");
const djsPath = path.join(import.meta.url, "../types/djs.d.ts");
const libPath = path.join(import.meta.url, "../types/lib.d.ts");
