...
class Group {
  constructor(options) {
    ...
    this.postconditionOptions = options.postconditionOptions == null
      ? Group.defaults.postconditionOptions : options.postconditionOptions;
    this.postconditions = options.postconditions == null ? Group.defaults.postconditions : options.postconditions;
    this.preconditionOptions = options.preconditionOptions == null
      ? Group.defaults.preconditionOptions : options.preconditionOptions;
    this.preconditions = options.preconditions == null ? Group.defaults.preconditions : options.preconditions;
    Group.validate(this);
  }
