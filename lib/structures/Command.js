...
class Command {
  constructor(options) {
    ...
    this.cooldowns = options.cooldown == null ? Command.defaults.cooldowns : options.cooldowns
  ...
  static setDefaults(options) {
    Command.defaults = {
      ...
      cooldowns: options.cooldowns == null ? undefined : options.cooldowns.map(cd => new Cooldown(cd)),
