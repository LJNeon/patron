...
class Registry {
  ...
  static validate(registry) {
    if(registry.library === "eris" || registry.library === "discordjs") {
      lib.setLibrary(registry.library);
      delete registry.library;
    }else{
      throw TypeError("Registry#library must be either 'eris' or 'discordjs'.");
    }
