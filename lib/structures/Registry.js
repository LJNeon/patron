...
class Registry {
   ...
   * @arg {(String|Array<ArgumentPrecondition>)} conditions An array or file path to a folder of
   * ArgumentPreconditions to register.
   ...
   * @arg {(String|Array<Command>)} commands An array or file path to a folder of Commands to register.
   * @returns {Registry} The registry in use.
   */
   ...
   * @arg {(String|Array<Group>)} groups An array or file path to a folder of Groups to register.
   * @returns {Registry} The registry in use.
   */
   ...
   * @arg {(String|Array<Postcondition>)} conditions An array or file path to a folder of Postconditions to register.
   * @returns {Registry} The registry in use.
   */
   ...
   * @arg {(String|Array<Precondition>)} conditions An array or file path to a folder of Preconditions to register.
   * @returns {Registry} The registry in use.
   */
   ...
   * @arg {(String|Array<TypeReader>)} readers An array or file path to a folder of TypeReaders to register.
   * @returns {Registry} The registry in use.
   */
  ...
  validateCommand(command) {
    ...
    for(let i = 0; i < command.arguments.length; i++) {
      ...
      for(let j = 0; j < arg.preconditions.length; j++) {
        if(!this.getArgumentPrecondition(arg.preconditions[i]))
