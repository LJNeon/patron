...
module.exports = new class CategoryChannelTypeReader extends TypeReader {
  constructor() {
  ...
  async read(cmd, msg, arg, args, val) {
    ...
    if (id != null || (id = val.match(Constants.regexes.id)) != null) {
      ...
      if (channel != null
          && channel.type === DiscordChannelType.Category)
        return TypeReaderResult.fromSuccess(channel);

      return TypeReaderResult.fromError(cmd, "Category channel not found.");
    }
