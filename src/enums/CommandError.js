 ...
 * @prop {Symbol} GuildOnly A guild only command being used in a DM/group channel.
 ...
 * @readonly 
 */
const CommandError = new Enum('Precondition', 'MemberPermission', 'BotPermission', 'TypeReader', 'GuildOnly', 'CommandNotFound', 'Cooldown', 'InvalidArgCount', 'Exception');
